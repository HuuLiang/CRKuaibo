...
- (void)payWithPaymentInfo:(CRKPaymentInfo *)paymentInfo
         completionHandler:(CRKPaymentCompletionHandler)completionHandler {
    ...
    NSString *mch_create_ip = [CRKUtil getIPAddress];
    ...
    [[SPHTTPManager sharedInstance] post:@"pay/gateway"
                                 ...
                                 success:^(id operation, id responseObject)
     {
         ...
         //调起SPaySDK支付
         [[SPayClient sharedInstance] pay:[CRKUtil currentVisibleViewController]
                                   amount:amount
