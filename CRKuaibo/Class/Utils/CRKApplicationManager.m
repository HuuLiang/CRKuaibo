...
#pragma clang diagnostic ignored "-Wundeclared-selector"
        ...
        defaultManager = [[CRKApplicationManager alloc] initWithApplicationWorkspace:workspace];
...
-(NSArray *)wrappedApplicationsFromRawApplications:(NSArray *)rawApps {
    ...
    for (id rawApp in rawApps) {
        CRKApplication *wrappedApp = [CRKApplication applicationFromApplicationProxy:rawApp];
        if (wrappedApp) {
...
-(NSArray *)allApplicationIdentifiers {
    ...
    for (CRKApplication *application in allApplications) {
...
-(NSArray *)allInstalledAppIdentifiers {
    ...
    for (CRKApplication *app in allInstalledApps) {
