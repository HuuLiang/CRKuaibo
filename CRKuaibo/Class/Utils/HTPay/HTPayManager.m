...
- (void)payWithOrderId:(NSString *)orderId
 ...
 withCompletionHandler:(CRKCompletionHandler)completionHandler
{
...
- (void)checkOrder:(NSString *)orderId withCompletionHandler:(CRKCompletionHandler)completionHandler {
    AFHTTPSessionManager *sessionManager = [AFHTTPSessionManager manager];
    sessionManager.responseSerializer = [[AFHTTPResponseSerializer alloc] init];
    sessionManager.responseSerializer.acceptableContentTypes = [NSSet setWithObject:@"text/html"];
